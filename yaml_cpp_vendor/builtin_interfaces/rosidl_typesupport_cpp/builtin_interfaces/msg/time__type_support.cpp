...
#include "builtin_interfaces/msg/detail/time__rosidl_typesupport_introspection_cpp.hpp"
...
{
  return ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, builtin_interfaces, msg, Time)();
}
