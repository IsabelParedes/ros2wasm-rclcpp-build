...
if(ON)
  message(STATUS "Using RMW implementation 'rmw_wasm_cpp'")
  if(NOT requested_rmw_implementation STREQUAL "rmw_wasm_cpp")
    message(FATAL_ERROR
      ...
      "only with support for 'rmw_wasm_cpp'.")
  endif()
  ...
  if(DEFINED rmw_wasm_cpp_TARGETS)
    ...
    target_link_libraries(rmw_implementation::rmw_implementation INTERFACE
      ${rmw_wasm_cpp_TARGETS})
  elseif(TARGET rmw_wasm_cpp::rmw_wasm_cpp)
    # Next preference: depend on a target with the package's name
    target_link_libraries(rmw_implementation::rmw_implementation INTERFACE
      rmw_wasm_cpp::rmw_wasm_cpp)
  else()
